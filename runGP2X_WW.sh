#!/bin/bash
#SBATCH --job-name=gp2x_WW            # Job name
...
#SBATCH --output=gp2x_WW_%j.log       # Standard output and error log
...
cp GP2X_WW.C ${WNAME}/GP2X_WW.C
cd ${WNAME}

root -l 'GP2X_WW.C('${NUMGEN}','${BES1}','${BES2}',"'${FNAME}'","'${GNAME}'","'${KNAME}'")'

echo 'Finished running GP2X_WW'
