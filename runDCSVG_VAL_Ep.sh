...
root -l 'FFTDetDeconv_Val.C(180,121.0,125.5,'${NBINS}',0.0001,250.0,124.975,0.19,"'${RNAME}'","'${FNAME}'","'${VERS}'","0.5*(DiMup4->E() - DiMup4->Pz())","0.5*(SDiMup4->E() - SDiMup4->Pz())")'
...
cp DECONSVG_VALP.C ${WNAME}/DECONSVG_VALP.C
cd ${WNAME}

root -l 'DECONSVG_VALP.C("'${FNAME}'","'${ONAME}'")'

echo 'Finished running DECONSVG_VALP'
